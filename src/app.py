...
# # Download transcript raw
# st.header("Scarica trascrizione")
# if st.session_state.transcription is not None:
#     raw_transcription_json = json.dumps(st.session_state.transcription, indent=4)
#     st.download_button("Download trascrizione raw", data=raw_transcription_json, 
#                        file_name="trascrizione.json", mime="application/json")

# # Download enhanced transcript
# st.header("Scarica trascrizione Pro")
# if st.session_state.transcription is not None:
#     raw_transcription_json = json.dumps(st.session_state.transcription, indent=4)
#     st.download_button("Download trascrizione pro", data=raw_transcription_json, 
#                        file_name="trascrizione_pro.json", mime="application/json")